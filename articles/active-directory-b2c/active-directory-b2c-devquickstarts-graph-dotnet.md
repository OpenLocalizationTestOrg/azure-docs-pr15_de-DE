...
Wenn Sie die Anwendung erfolgreich erstellt haben, sollten sie Eigenschaften der Anwendung wie oben diejenigen drucken. Sie benötigen beide `ObjectId` und `AppPrincipalId`, damit diese Werte, zu kopieren.
