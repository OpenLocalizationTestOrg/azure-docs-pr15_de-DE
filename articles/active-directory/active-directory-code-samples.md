...
| ObjC | [NativeClient-iOS](https://github.com/Azure-Samples/active-directory-ios) | Eine iOS-Anwendung, die eine Web-API-Anrufe erfordert Azure AD für die Authentifizierung ein.
| C#-/ .NET | [WebAPI-ManuallyValidateJwt-DotNet](https://github.com/Azure-Samples/active-directory-dotnet-webapi-manual-jwt-validation) | Einer systemeigenen Clientanwendung, die Logik zum Verarbeiten von ein JWT Token in einem Web-API, anstelle von OWIN Middleware enthält.
...
| C#-/ .NET | [NativeClient Monitor DotNet](https://github.com/Azure-Samples/active-directory-dotnet-native-headless) | Eine systemeigene Anwendung, die nicht interaktiven Authentifizierung durchführt und eine Web-API-Anrufe, die wird durch Azure AD gesichert.
