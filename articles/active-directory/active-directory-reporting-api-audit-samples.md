...
Das Skript gibt Ausgabe aus dem Auditbericht im JSON-Format zurück. Erstellt auch eine `audit.json` Datei mit der gleichen Ausgabe. Sie können experimentieren, indem Sie das Skript, um Daten aus anderen Berichte und kommentieren, die nicht benötigte Ausgabeformat zurück.
