...
Aktualisieren von Token sind Sicherheitstoken, in dem Ihre app neue Access Token in einen Fluss OAuth 2.0 erfassen können.  Sie können Ihre app langfristiges Zugriff auf Ressourcen im Namen eines Benutzers zu erreichen, ohne Interaktion vom Benutzer.
...
Zu diesem Zeitpunkt ist die nur token Überprüfung, die Ihre app Client ausführen muss sollten Id_tokens überprüfen.  Um eine Id_token zu überprüfen, sollte die app sowohl die Id_token der Signatur und die Ansprüche in der Id_token überprüfen.
