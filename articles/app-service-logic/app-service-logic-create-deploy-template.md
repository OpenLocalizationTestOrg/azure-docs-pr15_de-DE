...
Nachdem Sie Ihre Logik app-Vorlage erstellt haben, können Sie weiterhin Parameter, die Sie benötigen möglicherweise hinzufügen oder ändern. Wenn der Definition Ihrer eine Ressource-ID, um eine Azure-Funktion oder verschachtelte Workflow, den Sie in einer einzigen Bereitstellung bereitstellen möchten enthält, können Sie beispielsweise weitere Ressourcen zur Vorlage hinzufügen und IDs parametrisieren, je nach Bedarf. Dasselbe gilt für alle Verweise auf benutzerdefinierte APIs oder Swagger Endpunkte, die Sie für jede Ressourcengruppe erwarten bereitstellen.
