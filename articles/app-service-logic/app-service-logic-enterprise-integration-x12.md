...
|EDI-Überprüfung|Datentypen, die durch die Eigenschaften EDI das Schema, Länge Einschränkungen, leeren Datenelemente und nachfolgende Trennzeichen definierten führt EDI-Überprüfung.|
...
|Steuerelement Versionsnummer (ISA12)|Wählen Sie die Version von der standardmäßigen X12, die zum Generieren eines ausgehenden Austauschs durch das BizTalk-Portal verwendet wird.|
