...
## <a name="install-npm-package"></a>Installieren Sie die erforderlichen Komponenten
...
## <a name="obtain-ams-scripts"></a>Beziehen Sie Ihre Azure Mobile Dienste Skripts
...
## <a name="scaffold-app"></a>Scaffold Back-End-neue Azure Mobile-Apps
...
## <a name="deploy-ama-app"></a>Ihre Mobile-Apps Azure Back-End-Bereitstellung
