...
Sie können Anpassungen der App-Service-Umgebung mithilfe einer Matrix zurück in das neue **ClusterSettings** Attribut speichern. Dieses Attribut ist im Wörterbuch "Eigenschaften" der *HostingEnvironments* Azure Ressourcenmanager Entität gefunden.
