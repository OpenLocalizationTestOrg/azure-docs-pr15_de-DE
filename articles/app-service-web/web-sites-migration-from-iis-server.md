...
4.  Klicken Sie auf die Schaltfläche **Tool installieren** , um Web Apps Migrations-Assistenten auf Ihrem Computer installieren.
...
5.  Klicken Sie auf **Installieren** , auf Ihrem Computer zu installieren, klicken Sie im Bildschirm **Anwendung zu installieren** . Es wird auch entsprechende Abhängigkeiten wie Web bereitstellen, DacFX und IIS, installieren, falls erforderlich. 
...
8.  Das Bildschirmabbild unten zeigt drei Websites – **Standardwebsite**, **TimeTracker**und **CommerceNet4**. Alle diese verfügen über eine zugeordnete Datenbank, die migriert werden soll. Wählen Sie alle Websites, die Sie gerne würden bewerten, und klicken Sie dann auf **Weiter**.
