...
Standardmäßig Git Verfahren in App-Dienst mit composer.json, keine Auswirkung, wenn Sie eine in Ihrem Projekt von PHP haben. Sie können composer.json während der Bearbeitung aktivieren `git push` durch die Erweiterung Composer aktivieren.
