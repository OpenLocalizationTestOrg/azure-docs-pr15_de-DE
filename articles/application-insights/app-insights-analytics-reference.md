...
|||
|---|---|
| *Wert* `in` *Array*| True, wenn ein Element des *Arrays* vorhanden ist, die == *Wert*<br/>`where City in ('London', 'Paris', 'Rome')`
...
* *Beenden:* Der Wert des letzten Elements in der sich ergebenden Array oder den minimalen Wert, der größer ist als das letzte Element in der sich daraus ergebende Matrix und in eine ganze Zahl ist Vielfache von *Schritt* aus *Starten*.
...
Angebot einen Namen mit ['... '] or [" ... "] zu anderen Zeichen, oder verwenden ein Schlüsselwort als einen Namen. Zum Beispiel:
