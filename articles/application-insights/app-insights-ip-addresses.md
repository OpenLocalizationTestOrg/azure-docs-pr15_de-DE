...
Der [Visual Studio-Anwendung Einsichten](app-insights-overview.md) -Dienst verwendet eine Anzahl von IP-Adressen. Möglicherweise müssen Sie diese Adressen wissen, wenn die app, die Sie für die Überwachung sind eine Firewall gehostet wird.
