...
![Diagramme zum Überwachen der Leistung von Beispiel](./media/app-insights-nodejs/10-perf.png)
...
## <a name="add"></a>Erstellen Sie eine Anwendung Einsichten Ressource
...
![Klicken Sie auf neue, Anwendung Einblicken](./media/app-insights-nodejs/01-new-asp.png)
...
Suchen Sie nach Daten in der Prozessübersicht. Zuerst sehen Sie nur eine oder zwei Punkten. Zum Beispiel:
