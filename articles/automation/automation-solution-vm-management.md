...
StartByResourceGroup-ExcludeList-MS-Management-virtueller Computer | Geben Sie die Namen der virtuellen Computer Verwaltungsvorgang ausgeschlossen werden; Trennen Sie Namen mithilfe von semi-colon(;) aus. Werte sind Groß-/Kleinschreibung beachtet und Platzhalter (Sternchen) unterstützt wird.|
