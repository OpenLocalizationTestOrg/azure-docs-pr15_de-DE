...
**OData verknüpft service** In diesem Beispiel wird die Standardauthentifizierung verwendet. Finden Sie unter [OData verknüpft Dienst](#odata-linked-service-properties) Abschnitt für unterschiedliche Arten von Authentifizierung, die Sie verwenden können. 
