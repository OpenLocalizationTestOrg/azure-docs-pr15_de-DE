...
Azure Lake Datenspeicher ist eine unternehmensweite hyper-Skala Repository für große Daten analytisches Auslastung. Azure Daten Lake können Sie Daten von einem beliebigen Größe und Typ Aufnahme Geschwindigkeit an einem einzigen Ort für Betrieb und Allgemeines Analytics erfassen.
...
## <a name="DataLakeStoreSecurity"></a>Schützen von Daten in Azure Lake Datenspeicher
...
* [Verwenden Sie zum Kopieren von Daten an und von Azure Lake Datenspeicher DistCp (Hadoop Distributed Kopie)](https://mix.office.com/watch/1liuojvdx6sie)
