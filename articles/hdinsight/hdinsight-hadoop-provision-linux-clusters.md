...
* Verbinden Sie mit Ihrem lokalen Datencenter Netzwerk (zwischen Standorten oder Punkt-zu-Standort-) Cloudressourcen mithilfe eines virtuellen privaten Netzwerks (VPN).
