...
| generationId | erforderlich, schreibgeschützt | Eine Hub generierte, Groß-/Kleinschreibung beachtet Zeichenfolge mit maximal 128 Zeichen lang sein. Hiermit wird die Geräte mit der gleichen **Geräte-ID**, unterscheiden, wenn sie gelöscht und neu erstellt wurden. |
