...
- Wenn Sie mehrere Ressourcen- und möchten, laden Sie die Protokolle für nur eine Ressourcengruppe verfügen, verwenden Sie `-Blob '*/RESOURCEGROUPS/<resource group name>/*'`:
