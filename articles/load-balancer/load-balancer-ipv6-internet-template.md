...
Eine Vorlage Azure Ressourcenmanager enthält mehrere Variablen und Parameter, die Sie an Ihre Bedürfnisse anpassen können. Variablen werden für feste Werte verwendet, die Sie kein Benutzers ändern möchten. Parameter dienen Werte, die einen Benutzer angeben, wenn Sie die Vorlage bereitstellen soll. Die Beispielvorlage ist für den in diesem Artikel beschriebenen konfiguriert. Sie können dies in Ihrer Umgebung Anforderungen anpassen.
...
| vnetName | Geben Sie den Namen für die von den virtuellen Computern verwendete VNet. |
