...
A Die folgende Abfrage zeigt eine Beschreibung der alle Prüfungen, die aktuell ausgeführt werden:
...
**F: ändern kann ich den Namen der Tabelle/Blob-Container zum Lesen von Azure-Diagnose (WAD) verwendet?**  
...
Suchen Sie unter der Registerkarte **Azure Log Analytics (OMS)** nach einem grünen Häkchen. Einem grünen Häkchen bestätigt, dass der Agent mit OMS-Dienst kommunizieren.
