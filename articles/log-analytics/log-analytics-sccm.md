...
3. Konfigurieren Sie auf dem Bildschirm **Azure Active Directory** Ihre Verbindung zum OMS durch die Bereitstellung Ihrer **Mandanten** , **Client-ID** und **Client geheim Key** , und wählen Sie dann **Weiter**.  
