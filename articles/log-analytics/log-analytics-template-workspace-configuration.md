...
<properties
    pageTitle="Verwenden Sie Azure Ressourcenmanager Vorlagen zum Erstellen und Konfigurieren einer Log Analytics-Arbeitsbereich | Microsoft Azure"
...
1. Speichern Sie die angefügte Stichprobe in einer Datei, beispielsweise`azuredeploy.json` 
2. Bearbeiten Sie die Vorlage, damit die Konfiguration gewünschte
...
+ [Bereitstellen eines virtuellen Computers mit Linux und die Erweiterung Log Analytics virtueller Computer](https://azure.microsoft.com/documentation/templates/201-oms-extension-ubuntu-vm/)
