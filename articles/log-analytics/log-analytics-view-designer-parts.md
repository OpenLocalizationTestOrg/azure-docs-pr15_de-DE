...
Abfrage ausführen, wenn der Benutzer ein Element in der Liste auswählt.  Verwenden Sie die Syntax für Element aufnehmen möchten, die der Benutzer ausgewählt *{Ausgewähltes Element}* ein.
