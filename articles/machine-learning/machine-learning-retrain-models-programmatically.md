...
Wenn Sie mit Ihrer vorhandenen neue Azure Ressourcenmanager-basierten Webdienst beginnen möchten, finden Sie unter [neu trainieren einen vorhandenen Vorhersage Webdienst](machine-learning-retrain-existing-resource-manager-based-web-service.md).
...
1. Klicken Sie zum Schulung zukommen zurückzukehren, klicken Sie auf das Symbol Versuche im linken Bereich und dann auf den Versuch mit dem Namen Erhebung Model.  
...
Wenn Sie den Vorhersage Webdienst bereitgestellt, indem Sie auf **Bereitstellen Webdienst [klassischen]**, finden Sie unter [neu einen Webdienst klassischen trainieren](machine-learning-retrain-a-classic-web-service.md).
