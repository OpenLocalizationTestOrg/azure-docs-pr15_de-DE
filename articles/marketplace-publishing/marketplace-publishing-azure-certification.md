...
# <a name="get-pre-approved-via-the-microsoft-azure-certified-program"></a>Abrufen von über das Programm Microsoft Azure zertifiziert vorab genehmigt
...
> [AZURE.WARNING] Ihrer Dienste auf Microsoft Azure Marketplace verkaufen möchten, muss Ihr registrierte Entität aus einem der Länder genehmigten "Verkaufen-von" sein. Diese Einschränkung ist Auszahlung und Besteuerung Gründen. Wir werden aktiv diese Liste der Länder in Kürze erweitern, also demnächst gefunden. Eine vollständige Liste finden Sie unter Abschnitt 1 b der [Azure Marketplace Teilnahme Richtlinien](http://go.microsoft.com/fwlink/?LinkID=526833).
