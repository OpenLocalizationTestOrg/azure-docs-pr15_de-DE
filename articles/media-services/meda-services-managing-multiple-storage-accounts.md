...
In diesem Thema veranschaulicht, wie mehrere Speicherkonten mit einem Media Services-Konto mithilfe von Azure Service Management REST-API anfügen. Es wird gezeigt, wie verschiedene Speicher-Konten Erstellung von Anlagen mit dem Media Services SDK angegeben werden. 
...
- Primäre Speicher-Konto wird während Media-Dienste Konto Erstellungszeit angegeben. Sie können derzeit nicht Speicher Standardkonto ändern. 
