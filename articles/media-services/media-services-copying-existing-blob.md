...
- Zwei Media Services-Konten in einem neuen oder vorhandenen Azure-Abonnement. Finden Sie im Thema [zum Erstellen eines Media Services-Kontos](media-services-portal-create-account.md)ein.
...
1. Verwenden von Nuget Verweise Media-Dienste verwandte DLL-Dateien hinzufügen. In Visual Studio-Hauptmenü, wählen Sie Extras-Bibliothek Package Manager > -> Paket-Manager-Konsole. Geben Sie in den Typ des Fensters Console-Installationspaket windowsazure.mediaservices und drücken Sie die.
