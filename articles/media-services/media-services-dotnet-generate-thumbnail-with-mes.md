...
In diesem Thema wird gezeigt, wie Medien Services .NET SDK Codieren eines Wirtschaftsguts und Generieren von Miniaturansichten mit Media Encoder Standard verwenden. Das Thema definiert die XML und JSON Miniaturbildfenster Voreinstellungen, die Sie verwenden können, um einen Vorgang erstellen, der Codierung und Miniaturansichten gleichzeitig generiert. [Dieses](https://msdn.microsoft.com/library/mt269962.aspx) Dokument enthält eine Beschreibung der Elemente, die durch diese Voreinstellungen verwendet werden.
...
- Ausgabeformat explizit für jedes Bildformat bereitgestellt werden muss: Jpg/Png/BmpFormat. Wenn vorhanden ist, entspricht MWS usw. JpgVideo zu JpgFormat. Ausgabeformat wird ein neues Bild-Codec Makro bestimmte eingeführt: {Index}, welche muss werden vorführen (einmal und nur einmal) für Ausgabeformat Bild.
