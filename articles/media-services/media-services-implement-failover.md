...
1. Abrufen von den Containername der Quelle Anlage aus der schreibgeschützt SAS Locator im vorherigen Schritt erstellt. Wir benötigen diese Informationen für das Kopieren von Blobs zwischen Speicherkonten (später im Thema erläutert.)
...
1. Erstellen einer leeren Ziel-Anlage in der Zielliste Media-Dienste-Konto an.
...
1. Verwenden von Azure-Speicher SDK zum Kopieren von Blobs (Anlage Dateien) zwischen Speicher-Konto in "Data Center A" Quelle und Ziel-Speicher-Konto in "Data Center B" (diese Speicherkonten relevante Ressourcen zugeordnet sind.)
1. Zuordnen von Blobs (Objektdateien), die in der Zielliste Blob Container mit der Ziel-Anlage kopiert wurden. 
...
- Zwei Media Services-Konten in einem neuen oder vorhandenen Azure-Abonnement. Informationen Sie [zum Erstellen eines Media Services-Kontos](media-services-portal-create-account.md).
...
1. Ersetzen Sie die Definition der Standard-primär-Methode, durch die folgende Regel:
