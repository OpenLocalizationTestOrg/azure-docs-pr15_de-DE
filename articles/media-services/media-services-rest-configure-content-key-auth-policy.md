...
Wenn ein Stream von einem Player angefordert wird, verwendet Media Services den angegebenen Schlüssel dynamisch von Inhalten mit AES- oder PlayReady-Verschlüsselung verschlüsselt. Entschlüsseln des Streams wird der Player die Taste vom Übermittlungsdienst Key anfordern. Um zu entscheiden, und zwar unabhängig davon, ob der Benutzer berechtigt ist, können Sie die Taste gelangen, wertet der Dienst die Autorisierungsrichtlinien, die Sie für den Schlüssel angegeben haben.
...
####<a id="LinkContentKeyAuthorizationPoliciesWithOptions"></a>Link ContentKeyAuthorizationPolicies mit Optionen
...
####<a id="AddAuthorizationPolicyToKey"></a>Fügen Sie zu dem Inhalt Schlüssel Autorisierungsrichtlinie
