...
Microsoft Azure Media Services ist ein REST-basierten Dienst auf OData v3 erstellt. Aus diesem Grund können Sie hinzufügen, Abfragen, aktualisieren und löschen Einheiten im Wesentlichen die gleiche Weise, wie Sie auf eine beliebige andere OData-Dienst ist. Ausnahmen werden bei Bedarf Hervorhebung. Weitere Informationen zu OData finden Sie unter [Open Data Protocol-Dokumentation](http://www.odata.org/documentation/).
...
Jede Entität in Media-Dienste wird eine Sammlung Entität wie Posten, über eine POST-HTTP-Abfrage hinzugefügt.
