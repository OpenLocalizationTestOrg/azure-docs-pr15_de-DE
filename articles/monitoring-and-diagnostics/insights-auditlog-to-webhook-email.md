...
|resourceProviderName|Der Anbieter der betroffenen Ressource für Ressourcen.|
...
|Autorisierung      |Die RBAC Eigenschaften des Ereignisses. Umfassen in der Regel "Aktion", "Rolle" und "Bereich".|
