...
**Beispiel 1** - Maustaste auf die folgende Abfrage Codeausschnitt aus, damit es in eine neue Browserseite geöffnet, die JSFiddle lädt und führt die Abfrage aus:
