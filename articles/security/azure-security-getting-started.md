...
-   [Azure Anti-Malware](../security/azure-security-antimalware.md) wird auf allen Infrastrukturservern standardmäßig aktiviert. Sie können optional in eigene virtuellen Computern aktivieren.
