...
#### <a name="close-message-receiversender"></a>Schließen-Nachricht Empfänger/Absender
...
| Client                                                                                                | Dienstbus                                                                                                                   |
|------------------------------------------------------------------------------------------------------ |------------------------------------------------------------------------------------------------------------------------------ |
| --> Fluss (<br/>Hyperlink-Kreditkarte = 1<br/>)                                                                                 | Keine Aktion                                                                                                                             |
...
| Client                                                                                                    | Dienstbus                                                                                                                       |
|--------------------------------------------------------------------------------------------------------   |--------------------------------------------------------------------------------------------------------------------------------   |
| --> Fluss (<br/>Hyperlink-Kreditkarte = 3<br/>)                                                                                 | Keine Aktion                                                                                                                                 |
| Keine Aktion                                                                                                         | < übertragen ()<br/>Übermittlung-Id = {numerische Ziehpunkt}<br/>Übermittlung-Tag = {binäre Ziehpunkt}<br/>ausgeglichen =**falsch**,<br/>Weitere =**falsch**,<br/>Bundesstaat =**null**,<br/>fortsetzen =**false**<br/>)     |
...
| --> Anordnung (<br/>Rolle = Empfänger,<br/>zuerst = {Übermittlung-Id}<br/>letzten = {Übermittlung Id + 2}<br/>ausgeglichen =**Wahr**,<br/>Bundesstaat =**akzeptiert**<br/>)     | Keine Aktion                                                                                                                                 |
...
|------------------------------|-----------------------------|-----------------------------|
| Pfad der Anforderung Antwort erstellen | --> Anfügen ()<br/>Namen = {*Link Namen*}<br/>behandeln = {*numerische Ziehpunkt*}<br/>Rolle =**Absender**<br/>Quelle =**null**,<br/>Target = "Myentity / $Management"<br/>)                            |Keine Aktion                             |
