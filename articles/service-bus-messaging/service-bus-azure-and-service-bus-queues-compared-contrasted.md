...
Die Tabellen in den folgenden Abschnitten bieten eine logische Gruppierung der Warteschlange-Features und ermöglichen Ihnen, auf einen Blick die Funktionen, die in Azure Warteschlangen und Servicebuswarteschlangen vergleichen.
...
|Zunehmender Warteschlange TTL Wert|**Ja**<br/><br/>(über Compliance-Update von Sichtbarkeit Timeout)|**Ja**<br/><br/>(über eine dedizierte API-Funktion bereitgestellt)|
...
|WF integration|**Benutzerdefinierte**<br/><br/>(erfordert, erstellen eine benutzerdefinierte WF Aktivität)|**Systemeigenen**<br/><br/>(bietet Out-of-Box-WF-Aktivitäten)|
|Nachrichtengruppen durchsuchen|**Nein**|**Ja**|
