...
-   **ConnectHeaders** – alle HTTP-Header, die an den Endpunkt Relay vom Absender bereitgestellten, die auch die Sec-WebSocket-Protokoll und die Sec-WebSocket-Erweiterungen Spaltenüberschriften enthält.
