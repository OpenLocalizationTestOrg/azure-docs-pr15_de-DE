...
|SlowApiMonitoringDuration|Sekunden|300|Legt das Überwachung Intervall für verwaltete API Anrufe an. Beispiel: Benutzer bereitgestellt Sicherung Rückruf (Funktion). Nach Ablauf des Intervalls wird ein Warnung Gesundheit Bericht an den Status-Manager gesendet werden.|
