...
* Vorschriften die Stichprobe **WordCount 1.0.0** aus dem WordCount Anwendungspaket im Bild speichern.
* Zeigt die Liste der Anwendungstypen, wozu auch WordCount 1.0.0.
...
1. Kopieren Sie **C:\ServiceFabricSamples\Services\WordCount\WordCount\pkg\Debug** in **C:\Temp\WordCount**. Dadurch wird das Paket WordCount Anwendung erstellt.
2. Kopieren Sie C:\Temp\WordCount in **C:\Temp\WordCountUpgrade**. Dadurch wird das Paket **WordCountUpgrade Anwendung** erstellt.
3. Öffnen Sie **C:\Temp\WordCountUpgrade\ApplicationManifest.xml** in einem Text-Editor ein.
