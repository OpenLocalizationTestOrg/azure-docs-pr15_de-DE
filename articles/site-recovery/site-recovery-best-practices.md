...
Netzwerkadapter | Mehrere Netzwerkadapter werden unterstützt. |
Statische IP-Adresse | Unterstützt | Wenn die primäre virtuellen Computern eine statische IP-Adresse verwenden, die können Sie die statische IP-Adresse des virtuellen Computers angeben, die in Azure erstellt werden. Beachten Sie, dass statische IP-Adresse für einen Linux virtuellen Computer ausgeführt wird, klicken Sie auf Hyper-V nicht unterstützt wird.
