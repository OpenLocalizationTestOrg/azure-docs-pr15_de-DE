...
1.  Kopieren Sie den RHEL 6-64 Unified Agent binäre in den virtuellen Computer an. Führen Sie diesen Befehl, um die Binärdatei untar-Befehl: **tar – Zxvf <file name> **
...
2.  Wählen Sie in das **Master-Shape Ziel Servers** und **Prozess** dem lokalen master Ziel-Server und Azure-virtuellen Computer Prozess-Server aus.
