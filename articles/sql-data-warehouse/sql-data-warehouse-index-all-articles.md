...
| 47 | [Partitionierungstabellen in SQL Data Warehouse](sql-data-warehouse-tables-partition.md) | Erste Schritte mit Tabelle Verteilung in Azure SQL-Data Warehouse. |
...
| 54 | [Andere Dienste mit SQL Data Warehouse nutzen](sql-data-warehouse-overview-integrate.md) | Tools und Partner mit Lösungen, die mit SQL Data Warehouse integriert werden soll.  |
