...
- Eine Verbindung zu SQL-Datenbank. In diesem Artikel wird die **AdventureWorks** -Beispieldatenbank verwendet. Wenn die Datenbank AdventureWorks erhalten möchten, finden Sie unter [Erstellen der Demo-Datenbank](sql-database-get-started.md).
...
3. Klicken Sie im Abfrage-Fenster kopieren Sie, und fügen Sie den folgenden Code.
