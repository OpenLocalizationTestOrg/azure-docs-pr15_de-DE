...
3. Verwenden Sie die folgende **ALTER DATABASE** -Anweisung, um eine lokale Datenbank in einer Geo-Replikation primären mit einer lesbaren sekundäre Datenbank auf einem sekundären Server zu machen.
