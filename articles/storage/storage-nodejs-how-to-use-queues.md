...
2. Löschen Sie die Nachricht an.
...
* `options.visibilityTimeout`-Einen Timeout verlängern oder verkürzen Invisibility Befehlssatz

Im folgende Beispiel verwendet die Methode **GetMessages** , um 15 Nachrichten in einem Anruf zu gelangen. Dann verarbeitet jede Nachricht mit einer für Schleife. Invisibility Timeout wird auch auf fünf Minuten für alle Nachrichten, die von dieser Methode zurückgegebene festgelegt.
...
Klicken Sie dann die Clientanwendung verwendet die SAS mit **QueueServiceWithSAS** zum Ausführen von Vorgängen anhand der Warteschlange an. Im folgenden Beispiel wird eine Verbindung mit der Warteschlange und erstellt eine Nachricht.
...
-   Besuchen Sie das [Azure-Speicher SDK für Knoten][] Repository GitHub.
