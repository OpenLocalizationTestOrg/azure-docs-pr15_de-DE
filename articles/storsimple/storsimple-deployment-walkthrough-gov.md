...
|                                        | Gerät Administratorkennworts                     | Kennwort muss zwischen 8 und 15 Zeichen, Kleinbuchstaben, Großbuchstaben, numerischen und Sonderzeichen enthält. |        |
...
|   |   |  |  |
| **Vollständige minimalen Geräte-Einrichtung**          | Anzeigenamen für Ihr Gerät                     | Dies ist einen beschreibenden Namen für das Gerät aus. |        |
...
|   |   |  |  |
| **Erstellen eines Containers Lautstärke**                      | Volumen Containername:                            | Namen für den container                                                                                                                                                 |        |
...
MPIO Installation Anweisungen für ein StorSimple Gerät mit einem Linux-Server verbunden sind finden Sie unter [Konfigurieren von MPIO für Ihren Host Linux](storsimple-configure-mpio-on-linux.md).
