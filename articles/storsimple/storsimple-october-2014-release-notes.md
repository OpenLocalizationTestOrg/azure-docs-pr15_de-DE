...
- Ist die Version der Software 6.3.9600.17312 (Oktober 2014 Update) überschreiten, deaktivieren Sie die Ports Daten 2 und 3 von Daten, wenn vor dem Starten der Aktualisierung aktiviert. Wenn Sie die Daten 2 oder Daten 3 Ports aktiviert, wenn Sie das Update anwenden lassen, führt dies möglicherweise auf Ihrem Gerätecontroller Wiederherstellungsmodus wechseln. Bitte beachten Sie, dass, wenn Sie die Netzwerkschnittstellen zu deaktivieren, alle zugehörigen Datenträger offline geschaltet und die e/a für die Dauer der Aktualisierung unterbrochen.  
...
- Den Dienst StorSimple Manager Benutzeroberfläche können jetzt Ihr Gerätecontroller verwalten. Die Verwaltung, die Aktionen umfassen Neustart, ausschalten, oder einen Controller aktivieren. Weitere Informationen zum [Verwalten von StorSimple Gerätecontroller](storsimple-manage-device-controller.md)wechseln.  
- Sie können die WAN-Bandbreite Zuteilung entsprechend der Wochentag und die Uhrzeit des Tages Kombinationen planen. So können Sie besseren Nutzen WAN-Bandbreite in Zeiten vornehmen. Andere Bandbreite Vorlagen sind für andere Lautstärke Container zulässig. Weitere Informationen zum [Verwalten Ihrer StorSimple Bandbreite Vorlagen](storsimple-manage-bandwidth-templates.md)wechseln.  
...
| 3 | Geräte-failover | In der vorherigen Version wurde eine Wahrscheinlichkeit von inkonsistente Daten, wenn ein **Sicherung ermitteln** Auftrag während eines Failovers Gerät fehlgeschlagen. Dieses Problem ist jetzt behoben. | Ja | Nein |
| 4 | Geräte-failover | In der vorherigen Version, nach einem Failover Gerät Sicherungskopien angezeigt wurden, aber der Container zugeordneten Lautstärke wurde nicht auf dem Zielgerät vorhanden. Dieses Problem ist jetzt behoben. | Ja | Nein |
