...
1.  Klicken Sie auf der Seite **CPUs** passen Sie die **Anzahl der virtuellen Sockets** und die **Anzahl der Kerne pro virtuelle Sockets** , dass die **Gesamtzahl der Kerne** 4 (oder mehr) ist. Klicken Sie auf **Weiter**.
