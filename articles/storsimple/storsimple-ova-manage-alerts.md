...
|Benachrichtigung text|Ereignis|Weitere Informationen / empfohlene Aktionen|
|:---|:---|:---|
|Kennwort für <*Gerätenamen*> wird in <*Zahl*> Tagen ablaufen.|Kennwort-Warnung.| Ihr Kennwort läuft < Zahl < Tage. Erwägen Sie das Ändern Ihres Kennworts. Wechseln Sie für Weitere Informationen zu [Virtual Array StorSimple Gerät Administratorkennwort ändern](storsimple-ova-change-device-admin-password.md).
