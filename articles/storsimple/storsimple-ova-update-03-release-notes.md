...
In der folgenden Tabelle enthält eine Zusammenfassung der bekannten Probleme für die StorSimple virtuelle Matrix und umfasst die Probleme aus früheren Versionen Release notiert haben. 
...
| **9.** | Wiederherstellung | Sie können nur von einem Dateiserver in derselben Domäne wie mit dem Quellgerät die Wiederherstellung durchführen. Wiederherstellung an ein Gerät in eine andere Domäne wird in dieser Version nicht unterstützt. | Dies wird in einer späteren Version implementiert. |
...
| **12.** | CHAP | CHAP-Anmeldeinformationen, die nach der Erstellung können nicht entfernt werden. Darüber hinaus, wenn Sie die CHAP-Anmeldeinformationen ändern möchten, müssen Sie Offlineschalten der Datenmengen, und zeigen Sie diese online die vorgenommene Änderung wirksam wird. | Dieses Problem wird in einer späteren Version beschrieben. |
