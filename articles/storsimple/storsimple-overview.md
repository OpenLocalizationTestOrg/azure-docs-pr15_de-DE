...
| Spiegelung                 | Replikation von logischen Datenträger auf separaten Festplatte Laufwerke in Echtzeit, um kontinuierliche Verfügbarkeit sicherzustellen.|
...
| FAT bereitgestellt.               | Eine konventionelle Speicher provisioning in welcher Speicher Speicherplatz zugewiesen wird auf der Grundlage Anforderungen zu erwarten (und ist in der Regel neben der aktuellen Bedarf). Siehe auch *dünne bereitgestellt*.|
