...
## <a name="errors-during-the-required-network-settings"></a>Fehler während der erforderlichen Netzwerk-Einstellungen
...
| 5 | Aufrufen HcsSetupWizard: Cluster-Ressource nicht online (Ausnahme: 0x8007138c)| Clusterressourcen sind nicht online. | [Microsoft-Support wenden](storsimple-contact-microsoft-support.md) für den nächsten Schritten fort.|
...
- Support-Paketen und Gerät Protokolle 
