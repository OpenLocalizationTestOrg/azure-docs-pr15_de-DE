...
| Nein. | Feature | Problem | Fixed in aktualisieren | Physische Gerät gilt für | Virtuelles Gerät gilt für |
|-----|---------|-------|-----------------|---------------------------------|--------------------------------|
...
| Nein. | Feature | Problem | Kommentare/dieses Problem zu umgehen | Physische Gerät gilt für | Virtuelles Gerät gilt für |
|-----|---------|-------|----------------------------|----------------------------|---------------------------|
