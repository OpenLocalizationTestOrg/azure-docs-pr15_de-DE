...
Für ein System, das hoher Konsistenz benötigt, wird eine LOCAL_QUORUM für Konsistenz Ebene (zum Lesen "und" Schreiben ") sicherstellen, dass es sich bei die lokale Lese- und schreibt während der Daten auf die remote Data Centers asynchrone repliziert werden von den lokalen Knoten erfüllt sind.  Tabelle 2 enthält eine Übersicht über die Konfigurationsdetails für mehrere Region Cluster weiter unten in der Schreiben von Gliederungsdaten.
...
In diesem Schritt des Prozesses werden wir Ubuntu Bild mit erforderliche Software erstellen, damit das Bild für die Bereitstellung von mehreren Cassandra Knoten wiederverwendet werden kann.  
