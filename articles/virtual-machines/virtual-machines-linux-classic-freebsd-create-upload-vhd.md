...
6. Azure-Agent zu installieren.
    ...
    >[AZURE.IMPORTANT] Nach der Installation von Azure-Agent ist es eine gute Idee, vergewissern Sie sich, dass er ausgeführt wird:
...
1. Öffnen Sie die Azure PowerShell-Konsole an.
