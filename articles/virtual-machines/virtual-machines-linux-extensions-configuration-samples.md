...
Lernen Sie weitere Informationen zu diesen Erweiterungen klicken Sie hier: [Azure-virtuellen Computer Erweiterungen Übersicht.](virtual-machines-windows-extensions-features.md)
...
Hier ist eine vollständige virtueller Computer-Vorlage zum Erstellen einer Linux VM mit der Erweiterung ein:
