...
1. Klicken Sie auf **OK** , um den Benutzer **Installieren** erstellen. Dieses Konto wird so konfigurieren Sie Failovercluster und der Gruppe Verfügbarkeit verwendet werden.
