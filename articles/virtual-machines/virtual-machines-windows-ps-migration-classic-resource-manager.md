...
* **Option 2. Migrieren Sie zu einem vorhandenen virtuellen Netzwerk im Bereitstellungsmodell Ressourcenmanager**
    ...
    Überprüfen Sie zunächst, wenn Sie mit dem folgenden Befehl Cloud-Dienst migriert werden können:
