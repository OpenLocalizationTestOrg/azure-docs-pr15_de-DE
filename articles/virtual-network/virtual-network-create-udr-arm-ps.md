...
3. Erstellen einer Routing verwendet, um alle Datenverkehr an das Back-End-Subnetz (192.168.2.0/24) an die virtuelle **FW1** -Anwendung (192.168.0.4) weitergeleitet werden senden.
