...
5. Führen Sie den Befehl **Azure Gruppe anzeigen** , die Ressourcen erstellt, in die neue Ressourcengruppe anzeigen. 
...
>[AZURE.TIP] Wenn Sie alle Ressourcen, die nicht angezeigt werden, führen Sie die `azure group deployment show` aus, um den Status Bereitstellung der Bereitstellung sicherzustellen ist *erfolgreich*.