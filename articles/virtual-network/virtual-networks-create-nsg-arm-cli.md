<properties 
   ...
   description="Informationen Sie zum Erstellen und Bereitstellen von NSGs in die Verwendung der CLI Azure Cloud"
...
3. Führen Sie so erstellen eine NSG **Azure Netzwerk Nsg erstellen** Befehl aus
...
4. Führen Sie zum Erstellen einer Regel, die Zugriff auf Port 3389 (RDP) aus dem Internet zulässt Befehl **Azure Netzwerk Nsg Regel erstellen** .
    ...
    - **-r (oder – Richtung)**. Verbindung (eingehende oder ausgehende) Richtung.
...
6. Führen Sie den Befehl **Azure Netzwerk Vnet Subnetz einrichten** , zum Verknüpfen der NSG mit dem front-End-Subnetz.
...
4. Führen Sie so erstellen eine Regel, die Zugriff auf den Port 1433 (SQL) ermöglicht aus dem front-End-Subnetz **Azure Netzwerk Nsg Regel erstellen** Befehl aus
...
6. Führen Sie den Befehl **Azure Netzwerk Vnet Subnetz einrichten** , zum Verknüpfen der NSG mit dem Back-End-Subnetz.
