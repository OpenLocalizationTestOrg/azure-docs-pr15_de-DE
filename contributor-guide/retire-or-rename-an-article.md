# <a name="steps-to-follow-when-you-retire-or-change-the-name-of-an-acom-technical-article"></a>Die folgenden Schritte beim zurückziehen oder Ändern des Namens eines ACOM technischen Artikel
