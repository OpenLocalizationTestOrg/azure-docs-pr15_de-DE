...
2. In `didFinishLaunchingWithOptions` in **QSAppDelegate.m**, einfügen die folgenden Linien unmittelbar vor dem `return YES;`:
...
1. Fügen Sie die Datei **ClientManager.swift** mit dem folgenden Inhalt hinzu. Ersetzen Sie mit der URL der Azure Mobile-App Back-End- _AppUrl %_ ein.
