## <a name="using-vault-credentials-to-authenticate-with-the-azure-backup-service"></a>Mit dem Dienst Azure Sicherung Besprechungsteilnahme mithilfe Tresor Anmeldeinformationen
