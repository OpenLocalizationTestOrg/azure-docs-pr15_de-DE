In diesem Exemplarische Vorgehensweise erfahren Sie, wie den Trigger **Vertrieb - beim Erstellen ein Objekts** verwendet einen Logik app Workflow einleiten, beim Erstellen ein neues Leads in Ihrer Vertrieb.
