...
Wenn Sie einen SRV-Eintrag im Stammverzeichnis einer Zone erstellen, geben Sie einfach *_service* und *_protocol* in den Namen des Datensatzes. Es ist nicht erforderlich, um einzuschließen "@" in den Namen des Datensatzes.
